...
use App\Http\Controllers\Flight\FlightsController;
...
Route::get('popularCountries',[FlightsController::class, 'popularCountries']);
...
Route::group( ['prefix' => 'airline','middleware' => ['auth:airline-api'] ],function(){

    Route::post('dashboard',[HotelController::class, 'dashboard'])->name('airline.dashboard');
});
